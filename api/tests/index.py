...
class FlaskTestCase(unittest.TestCase):
    ...
    def test_200(self):
        """Tests that the status code response is 200."""
        res = self.app.get('/')
        self.assertEqual(res.status_code, 200)

    def test_status(self):
        """Tests that the JSON response data "status" == "OK"."""
        res = self.app.get('/')
    ...
    def test_time(self):
        ...
        current time (only: year, month, day, hour and minute).
        """
    ...
    def test_time_utc(self):
        ...
        the current utc_time (only: year, month, day, hour and minute).
        """
